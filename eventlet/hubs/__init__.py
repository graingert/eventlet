...
def trampoline(fd, read=None, write=None, timeout=None,
               timeout_exc=timeout.Timeout, _allow_multiple_readers=False):
    ...
    *timeout* elapses, depending on arguments specified.
    ...
    try:
        if read:
            listener = hub.add(hub.READ, fileno, current.switch, _allow_multiple_readers=_allow_multiple_readers)
        elif write:
